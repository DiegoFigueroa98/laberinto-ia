...
class NavBar extends Component {
  ...
  selectAlgorithm(selection) {
    ...
    if (
      ...
      this.state.algorithm === "Visualizar Algoritmo" ||
      this.state.algorithm === "Selecciona un algoritmo!"
    ) {
  ...
  visualizeAlgorithm() {
    ...
    if (
      ...
      this.setState({ algorithm: "Selecciona un algoritmo!" });
    } else {
              ...
              <div className="dropdown">
                ...
                <div className="dropdown-menu" aria-labelledby="dropdownMenu1">
                  ...
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      this.selectAlgorithm("Visualizar Busqueda en profundidad")
                    }
                  >
